...
const PricingCard = ({
  ...
  return (
    <div className="relative w-full max-w-lg hover:scale-103 hover:transition-all duration-200">
      <div
        className={`relative flex flex-col h-full gap-4 lg:gap-8 z-10 p-8 border-[1px] border-gray-500/20 rounded-2xl ${
      ...
      >
        ...
        <div className="flex gap-2 ">
          ...
          <div className="flex flex-col justif-end mb-[4px] ">
  ...
  return (
    <section className="relative overflow-hidden " id="pricing">
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 lg:pt-12">
        <div className="flex items-center justify-center w-gull pb-12">
